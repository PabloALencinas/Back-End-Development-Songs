...
def songs():
    try:
        ...
        # Create a response dictionary with the key "songs" and the list of songs
        ...
        # Create an HTTP response object with the specified headers
        ...
        return jsonify({"error": "An error occurred while retrieving songs"}), 500
